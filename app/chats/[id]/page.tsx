    ...
    return (
        <div className={"py-10 px-4 space-y-4"}>
            ...
            <div className={"fixed py-2 bg-white bottom-2 inset-x-0"}>
                <div className={"flex relative items-center w-full mx-auto max-w-md"}>
                    <input className={"shadow-sm rounded-full w-full border-gray-300 focus:ring-orange-500 focus:outline-none focus:border-orange-500"} type="text" />
