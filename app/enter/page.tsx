        ...
        <div className={"mt-16 px-4"}>
            ...
            <div className={"mt-8"}>
                    ...
                    <div className={"grid border-b w-full mt-8 grid-cols-2 gap-16"}>
                        <button className={cls(
                            ...
                            method === "email"
                                ...
                                : "border-transparent"
                        )} onClick={onEmailClick}>Email Address</button>
                        <button className={cls(
                            "pb-4 font-medium",
                            method === "phone"
                                ? "border-b-2 border-orange-500 text-orange-400"
                ...
                <form className={"flex flex-col mt-8"}>
                    ...
                    <div className={"mt-1"}>
                        ...
                        {method === "phone" ? (
                            <div className={"flex rounded-md shadow-sm"}>
                                <span className={"flex items-center justify-center px-3 rounded-l-md border border-l-0 border-gray-300 bg-gray-50 text-sm text-gray-500 select-none"}>+82</span>
                    ...
                    <button className={"mt-4 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none"}>
                ...
                <div className={"mt-6"}>
                    ...
                    <div className={"grid grid-cols-2 gap-3 mt-2 gap-3"}>
